    ...
    <section class="py-20 bg-white dark:bg-slate-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-[#f8fafc] dark:bg-slate-800 rounded-3xl min-h-[500px] border-2 border-dashed border-[#E5E5E5] dark:border-slate-700 flex items-center justify-center p-8 text-center relative">
                    <div class="absolute inset-0 bg-cover bg-center opacity-5" style="background-image: url('https://d16y57bdjt0bnh.cloudfront.net/website-assets/Initium%201@4x_transparent.png');"></div>
                    <div class="relative z-10 text-slate-400">
                        <svg class="w-16 h-16 mx-auto mb-4 text-[#C7A74A]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                        <p class="font-bold text-lg mb-2">[Diagrama de Arquitectura Visual]</p>
                        <p class="text-sm max-w-sm">Requerimientos para diseño: Tres vistas (Dispositivo, Backend, Portal). Incluir flujos de métricas y seguridad. Elementos: Devices, API Gateway, Serverless, NoSQL, AI/Analítica.</p>
                    </div>
                </div>
            </div>
        </div>
